...
sessionsAsRelation sessions = do
  ...
  pure $ mkRelationFromList (attributesFromList [Attribute "sessionid" stringAtomType,
                             Attribute "parentCommit" stringAtomType]) atomMatrix
