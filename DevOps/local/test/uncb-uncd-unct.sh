...
begin_banner "Top level" "Cont. UnBuild, UnDeploy and UnTest"

warn "Nothing can be filled by default, you must build the top level UnCB-UnCD-UnCT pipeline yourself."
warn "Refer to the uncb-uncd-unct.sh of some specific sub project for some example"
...
done_banner "Top level" "Cont. UnBuild, UnDeploy and UnTest"
