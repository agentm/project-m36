...
begin_banner "Top level" "Cont. UnDeploy and UnTest"

warn "Nothing can be filled by default, you must build the top level UnCD-UnCT pipeline yourself."
warn "Refer to the cd-ct.sh of some specific sub project for some example"
...
done_banner "Top level" "Cont. UnDeploy and UnTest"
