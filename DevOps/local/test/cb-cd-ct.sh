...
begin_banner "Top level" "Cont. Build, Deploy and Test"

warn "Nothing can be filled by default, you must build the top level CB-CD-CT pipeline yourself."
warn "Refer to the cb-cd-ct.sh for some example"
...
done_banner "Top level" "Cont. Build, Deploy and Test"
