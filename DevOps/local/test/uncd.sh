...
begin_banner "Top level" "Cont. UnDeploy"

warn "Nothing can be filled by default, you must build the top level UnCD pipeline yourself."
warn "Refer to the uncd.sh of some specific sub project for some example"
...
done_banner "Top level" "Cont. UnDeploy"
