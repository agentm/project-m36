...
begin_banner "Top level" "Cont. Test"

warn "Nothing can be filled by default, you must build the top level CT pipeline yourself."
warn "Refer to the ct.sh for some example"
...
done_banner "Top level" "Cont. Test"
