...
begin_banner "Top level" "Cont. Build and Deploy"

warn "Nothing can be filled by default, you must build the top level CB-CD pipeline yourself."
warn "Refer to the cb-cd.sh for some example"
...
done_banner "Top level" "Cont. Build and Deploy"
