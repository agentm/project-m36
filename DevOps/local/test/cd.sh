...
begin_banner "Top level" "Cont. Deploy"

warn "Nothing can be filled by default, you must build the top level CD pipeline yourself."
warn "Refer to the cd.sh for some example"
...
done_banner "Top level" "Cont. Deploy"
