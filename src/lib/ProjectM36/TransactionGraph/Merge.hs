...
unionMergeAggregateFunctions :: MergePreference -> AggregateFunctions -> AggregateFunctions -> Either MergeError AggregateFunctions
unionMergeAggregateFunctions prefer funcsA funcsB =
  case prefer of
  PreferFirst -> pure $ HS.union funcsA funcsB
  PreferSecond -> pure $ HS.union funcsB funcsA
  PreferNeither -> pure $ HS.union funcsA funcsB
