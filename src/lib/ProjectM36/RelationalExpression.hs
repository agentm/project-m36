          ...
          case eAtomTypes of
            ...
            Right atomTypes -> do
              let mValidTypes = map (\(expType, actType) -> case atomTypeVerify expType actType of 
                  ...
                  eAtomArgs = map (\arg -> runGraphRefRelationalExprM gfEnv (evalGraphRefAtomExpr emptyTuple arg)) atomArgExprs
